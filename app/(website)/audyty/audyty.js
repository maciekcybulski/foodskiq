...
const features = [
  {
    ...
    description:
      'Zwiększamy wiarygodność wyników badań. Dzięki którym można podjąć słuszne działania i procesy naprawcze',
    icon: HomeIcon,
  },
  {
    ...
    <h1 className="text-center text-3xl font-semibold tracking-tight dark:text-white lg:text-4xl lg:leading-snug">
        ...
        <div className="text-center">
          <p className="mt-2 text-lg">
            Analiza działań i procesów w zakładzie pracy
          </p>
        </div>
    ...
    <div className="bg-white py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          <h2 className="text-base font-semibold leading-7 text-indigo-600">Wykonaj audyt w swojej firmie</h2>
          <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
            Zyskaj przewagę konkurencyjną, popraw jakość i zgodność z przepisami.
          </p>
        </div>
